    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamReservations", x => new { x.Id, x.ExamId });
                    table.ForeignKey(
                        name: "FK_ExamReservations_AspNetUsers_ParticipantId",
                        column: x => x.ParticipantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExamReservations_Exams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamReservations_Vouchers_VoucherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamReservations_ExamId",
                table: "ExamReservations",
                column: "ExamId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamReservations_ParticipantId",
                table: "ExamReservations",
                column: "ParticipantId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamReservations_VoucherId",
                table: "ExamReservations",
                column: "VoucherId");
