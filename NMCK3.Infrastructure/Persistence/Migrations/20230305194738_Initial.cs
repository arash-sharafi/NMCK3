        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUser_Email = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vouchers_AspNetUsers_BuyerId",
                        column: x => x.BuyerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReadingScore = table.Column<double>(type: "float", nullable: false),
                    ...
                    ScoreSubmitDate = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamReservation", x => new { x.Id, x.ExamId });
                    table.ForeignKey(
                        name: "FK_ExamReservation_AspNetUsers_ParticipantId",
                        column: x => x.ParticipantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExamReservation_Exams_ExamId",
                        column: x => x.ExamId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExamReservation_Vouchers_VoucherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamReservation_ExamId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamReservation_ParticipantId",
                table: "ExamReservation",
                column: "ParticipantId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamReservation_VoucherId",
                table: "ExamReservation",
                column: "VoucherId");
